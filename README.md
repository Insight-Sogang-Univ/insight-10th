...
plt.show()
```
![BoxPlot](https://github.com/onukki/insight-10th/assets/144572748/5e0004e5-5458-4d5a-a568-5767f3661612)
...
- 다른 값(평균 등)으로 대체, 결측값과 유사하게 다른 변수들을 사용해서 예측모델을 만들고, 이상값을 예측한 후 해당 값으로대체
4) 변수화
